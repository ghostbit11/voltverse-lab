...
.side{background:#0a2540;color:#c7d5e8;padding:0}
...
.brand .dot{width:30px;height:30px;border-radius:8px;background:linear-gradient(135deg,#00c2a8,#1a73e8);display:grid;place-items:center;font-size:1rem}
...
.snav a.on{background:linear-gradient(90deg,rgba(0,194,168,.2),transparent);color:#fff;box-shadow:inset 3px 0 0 #00c2a8}
...
.balcard{background:linear-gradient(135deg,#0a2540,#1a56db);color:#fff;border:0}
...
.qa a:hover{border-color:#1a56db;box-shadow:0 4px 14px rgba(26,86,219,.12)}
...
.field input:focus{border-color:#1a56db;outline:none}
.btn{display:inline-block;border:0;border-radius:8px;padding:.75rem 1.4rem;font-weight:700;cursor:pointer;font-size:.95rem}
.btn-p{background:#1a56db;color:#fff}.btn-g{background:#fff;color:#1a56db;border:1px solid #cdd8e6}.btn.full{display:block;width:100%}
...
<aside class="side"><div class="brand"><span class="dot">◆</span> Aurora<span style="color:#00c2a8">Bank</span></div>
<nav class="snav">';
